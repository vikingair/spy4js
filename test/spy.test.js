...
describe('Spy - Utils', () => {
    ...
    it(
        'throws an exception that the spy was never called if not called' +
    ...
    it('should throw if trying to spy other attributes ' + 'than functions', () => {
        ...
        throws(() => Spy.on(testObject, 'attrString'), { partOfMessage: 'only spy on functions!' });
        throws(() => Spy.on(testObject, 'attrNumber'), { partOfMessage: 'only spy on functions!' });
        throws(() => Spy.on(testObject, 'attrNull'), { partOfMessage: 'only spy on functions!' });
        throws(() => Spy.on(testObject, 'attrDate'), { partOfMessage: 'only spy on functions!' });
        throws(() => Spy.on(testObject, 'attrObject'), { partOfMessage: 'only spy on functions!' });
        throws(() => Spy.on(testObject, 'attrUnknown'), { partOfMessage: 'only spy on functions!' });
    });
    ...
    it('should throw if trying to spy on already spied attributes.', () => {
        ...
        throws(() => Spy.on(testObject, 'attr'), { partOfMessage: 'was already spied' });
    ...
    it('throws an exception if getCallArguments gets called with float', () => {
        const spy = new Spy();
        spy(123);
        throws(() => spy.getCallArguments(0.5), { partOfMessage: 'callNr "0.5" was not valid' });
    });
    ...
    it('should recognize when the Spy was not called', () => {
        ...
        throws(() => spy.wasNotCalled(), { partOfMessage: 'was not considered to be called' });
    });
    ...
    it('should throw if requested and called', () => {
        ...
        spy.throws(null);
        throws(() => spy({ _key: 'callParams2' }, { partOfMessage: 'was requested to throw' }));
    });
    ...
    it('should make the spy transparent' + ' (mainly for spies on object properties)', () => {
        ...
        throws(() => testObject.someFunc('test', 6), { message: 'never call this func directly' });
    ...
    it('should make the spy transparent after' + ' a certain amount of calls', () => {
        ...
        throws(() => testObject.someFunc('test3', { testProp: 'test' }), { message: 'never call this func directly' });
        throws(() => testObject.someFunc('test4'), { message: 'never call this func directly' });
    ...
    it('should do nothing after for transparent restored spy', () => {
        ...
        testObject.someFunc();
        throws(() => testObject.someFunc('test4'), { message: 'never call this func directly' });
        throws(() => testObject.someFunc('test5'), { message: 'never call this func directly' });
        ...
        throws(() => testObject.someFunc('test6'), { message: 'never call this func directly' });
    ...
    it('does not allow to configure not mocking spies to be persistent', () => {
        ...
        throws(() => spy.configure({ persistent: true }), { partOfMessage: 'does not mock any object' });
        throws(() => spy.configure({ persistent: false }), { partOfMessage: 'does not mock any object' });
    });
    ...
    it('does not allow to restore persistent spies', () => {
        ...
        throws(() => spy.restore(), { partOfMessage: 'was configured to be persistent' });
